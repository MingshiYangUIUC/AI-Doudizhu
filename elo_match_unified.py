...
if __name__ == '__main__':
    ...
    players = [str(i).zfill(10) for i in range(600000,1450000+1,100000)]
    versions = ['H15-V5.1']
    ...
    for session in players:
        for version in versions:
            ...
            Model_Unified = Network_V3_Unified(20)
            Model_Unified.load_state_dict(torch.load(os.path.join(wd,'models',f'Unified_{version}_{str(session).zfill(3)}.pt')))
            Model_Unified.eval()
