...
def get_action_serial_V2_2_1(Turn, SLM, QV, Initstates,unavail,lastmove, Forcemove, history, temperature):
    player = Initstates[Turn%3]#.clone().detach()
    visible = Initstates[-1]#.clone().detach()
...
def evaluate_action_serial_V2_2_1(Turn, SLM, QV, Initstates, unavail, lastmove, Forcemove, history, temperature, Action):
    player = Initstates[Turn%3]
    visible = Initstates[-1]
