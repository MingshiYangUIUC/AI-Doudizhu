...
if __name__ == '__main__':
    ...
    #players = [str(i).zfill(10) for i in range(100000,900000+1,100000)]
    #versions = ['H15-V3']#,'H06-V3']#,'H12-V1']#,'H06-V2']

    '''players = [str(i).zfill(3) for i in range(9,300,20)]
    versions = ['res-v1']#,'H06-V3']#,'H12-V1']#,'H06-V2']'''

    names = ['H15-V4_0034000000','H15-V4_0038200000']
    ...
    for name in names:
        ...
        #try:
        LM.load_state_dict(torch.load(os.path.join(wd,'models',f'LM_{name}.pt')))
        DM.load_state_dict(torch.load(os.path.join(wd,'models',f'DM_{name}.pt')))
        UM.load_state_dict(torch.load(os.path.join(wd,'models',f'UM_{name}.pt')))
